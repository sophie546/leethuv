...
Can you solve this real interview question? Weighted Word Mapping - You are given an array of strings words, where each string represents a word containing lowercase English letters.
